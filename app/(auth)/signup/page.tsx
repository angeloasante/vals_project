    ...
    <div className="min-h-screen flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-rose-100 mt-2">Create your love page 💕</p>
        </div>
        ...
        <div className="bg-white/95 backdrop-blur rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-28 pr-4 py-3 rounded-xl border border-gray-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-200 outline-none transition-all text-gray-900 bg-white"
            ...
            >
              {loading ? "Creating account..." : "Create My Love Page"}
            </button>
          </form>
